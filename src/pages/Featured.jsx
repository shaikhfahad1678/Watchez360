      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8 flex-1 w-full">
        ...
        {loading ? (
          <div className="text-center py-24">
            ...
            <p className="text-xs font-semibold text-neutral-500 mt-4 uppercase tracking-widest animate-pulse">Syncing Featured Calibres...</p>
          </div>
        ) : products.length > 0 ? (
          ...
          <div className="text-center py-20 border border-dashed border-neutral-200 rounded-3xl mb-16 max-w-xl mx-auto px-6">
            <h3 className="text-sm font-black uppercase tracking-wider text-black mb-1">No Featured Timepieces</h3>
            <p className="text-xs text-neutral-500 font-medium mb-5 leading-relaxed">
              We couldn't find any watches in the featured category at this moment.
            </p>
          </div>
        )}
      </div>
